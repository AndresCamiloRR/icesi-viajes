...
public class TipoIdentificacionServiceImpl implements TipoIdentificacionService{
    ...
    @Override
    public Optional<TipoIdentificacion> findById(Integer aint) {
        return tipoIdentificacionRepository.findById(aint);
    }
    ...
    @Override
    public void deleteById(Integer aint) throws Exception {
        tipoIdentificacionRepository.deleteById(aint);
    }
